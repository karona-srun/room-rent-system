...
<body>
                ...
                <ul class="menu-inner py-1">
                    <li class="menu-item {{ Request::is('dashboard*') ? 'active' : '' }}">
                        <a href="{{ url('/dashboard') }}" class="menu-link">
                            ...
                            <div data-i18n="Dashboards">{{ __('app.dashboard') }}</div>
                        </a>
                    </li>
                    <li class="menu-item {{ Request::is('customers*') ? 'active' : '' }}">
                        <a href="{{ route('customers.index') }}" class="menu-link">
                            <i class="menu-icon tf-icons bx bx-user"></i>
                            <div data-i18n="Customer">{{ __('app.customer') }}</div>
                        </a>
                    </li>
                    <li class="menu-item {{ Request::is('rooms*') ? 'active' : '' }}">
                        <a href="{{ route('rooms.index') }}" class="menu-link">
                            <i class="menu-icon tf-icons bx bx-buildings"></i>
                            <div data-i18n="Room">{{ __('app.room') }}</div>
                        </a>
                    </li>
                    <li class="menu-item {{ Request::is('room-rents*') ? 'active' : '' }}">
                        <a href="{{ url('room-rents') }}" class="menu-link">
                            ...
                            <li class="nav-item navbar-dropdown dropdown-user dropdown">
                                <a class="nav-link dropdown-toggle hide-arrow" href="javascript:void(0);"
                                    ...
                                    <div class="avatar avatar-online">
                                        <img src="{{ asset('assets/img/avatars/user1.png') }}" alt
    ...
    <div class="modal" id="backDropModalSuccess" data-bs-backdrop="static" tabindex="-1" aria-modal="true"
        role="dialog">
    ...
    <div class="modal" id="backDropModalUpdate" data-bs-backdrop="static" tabindex="-1" aria-modal="true"
        role="dialog">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
    ...
    <div class="modal" id="backDropModalDelete" data-bs-backdrop="static" tabindex="-1" aria-modal="true"
        role="dialog">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
    ...
    @endif
    @if (Session::get('mode') == 'update')
        <script>
            $(document).ready(function() {
                $('#backDropModalUpdate').modal('show');
            });
        </script>
    @endif
